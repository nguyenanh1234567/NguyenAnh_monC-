...
// Definition of function showState. This function uses an fstream reference as its parameter.
// The return values of the eof(), fail(), bad(), and good() member functions are displayed.
