...
int main()
{
    ...
    // Move to byte 5 from the beginning of the file (the 6th byte) and read the character there.
    ...
    // Move to byte 3 from the current position (the 4th byte) and read the character there.
